    ...
    while not flag:
        ...
        if results.pose_world_landmarks:
            ...
            if (angle_left_knee >= 90 and angle_left_knee <= 120) and (angle_right_knee >= 90 and angle_right_knee <= 120) and (angle_left_hand <= 180 and angle_left_hand >= 150) and (angle_right_hand <= 180 and angle_right_hand >= 150):
                ...
                cv2.putText(preview, "Right Hand Angle: {:f}".format(angle_right_hand), (400, 460), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 255, 0), 1, cv2.LINE_AA)
            ...
            # YELLOW   
                ...
                cv2.putText(preview, "Right Angle: {:f}".format(angle_right_knee), (400, 410), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 255, 255), 1, cv2.LINE_AA)
                cv2.putText(preview, "Right Hand Angle: {:f}".format(angle_right_hand), (400, 460), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 255, 255), 1, cv2.LINE_AA)
            ...
            # RED
                ...
                cv2.putText(preview, "Right Hand Angle: {:f}".format(angle_right_hand), (400, 460), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 0, 255), 1, cv2.LINE_AA)
